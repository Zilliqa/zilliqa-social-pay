      ...
      <LinkContainer href="https://nextid.com/covidheroes/">
        <Linkbutton>
          ...
          <Text
            ...
            css="font-size: 14px;"
          >
            Craft and share a personalised, blockchain-verified certificate of appreciation for our COVID Heroes,
            auto-generated by NextID.
          </Text>
        </Linkbutton>
      </LinkContainer>
      <LinkContainer href="https://redcross.give.asia/campaign/essentials-delivered-to-migrant-workers/donate?#/amount">
        <Linkbutton>
          ...
          <Text
            ...
            css="font-size: 14px;"
          >
            Keen to do more? Support Singapore Red Cross
            in their fight against COVID-19 by making a direct donation on their website.
          </Text>
        </Linkbutton>
      </LinkContainer>
    </CovidPageContainer>
