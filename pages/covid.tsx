      ...
      <LinkContainer href="https://nextid.com/covidheroes/">
        <Linkbutton>
          ...
          <Text
            ...
            css="font-size: 14px;"
          >
            Recognise people who have served their community,&nbsp;
            and share a personalised, blockchain-verified certificate of appreciation,&nbsp;
      ...
      <LinkContainer href="https://redcross.give.asia/campaign/essentials-delivered-to-migrant-workers/donate?#/amount">
        <Linkbutton>
          ...
          <Text
            ...
            css="font-size: 14px;"
          >
            Keen to do more? Support Red Cross Singapore&nbsp;
            in their fight against Covid-19 by making a direct donation via their website.
          </Text>
        </Linkbutton>
      </LinkContainer>
    </CovidPageContainer>
